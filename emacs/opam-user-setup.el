...
;; ## added by OPAM user-setup for emacs / tuareg ## c22887beee22d071a888b3a81e0f2a68 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/yuta/.opam/5.3.0+BER/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## be1857001bc2c24cee386f60cdb5a8f2 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (member "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/yuta/.opam/5.3.0+BER/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/yuta/.opam/5.3.0+BER/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/yuta/.opam/5.3.0+BER/bin/ocp-indent"))
